...
a.appendChild(c);c.styleSheet&&!c.sheet?c.styleSheet.cssText=d:c.appendChild(document.createTextNode(d))};f.cssjs=e})(this);var tdcLoader={init:function(){}};jQuery(window).on('load',function(){jQuery("body").addClass("tdcComposerLoaded")});var tdcLivePanel;
