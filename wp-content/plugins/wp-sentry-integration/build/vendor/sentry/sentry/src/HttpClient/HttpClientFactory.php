...
use WPSentry\ScopedVendor\Http\Adapter\Guzzle6\Client as Guzzle6HttpClient;
use WPSentry\ScopedVendor\Http\Adapter\Guzzle7\Client as Guzzle7HttpClient;
...
final class HttpClientFactory implements \Sentry\HttpClient\HttpClientFactoryInterface
{
    ...
    private function resolveClient(\Sentry\Options $options)
    {
        ...
        if (\class_exists(\WPSentry\ScopedVendor\Http\Adapter\Guzzle7\Client::class) || \class_exists(\WPSentry\ScopedVendor\Http\Adapter\Guzzle6\Client::class)) {
            ...
            if (\class_exists(\WPSentry\ScopedVendor\Http\Adapter\Guzzle7\Client::class)) {
                return \WPSentry\ScopedVendor\Http\Adapter\Guzzle7\Client::createWithConfig($guzzleConfig);
            }
