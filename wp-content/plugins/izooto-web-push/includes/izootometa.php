 ...
 */
function izooto_curl_request( $array, $url = 'http://api.izooto.com/plugin/wp/notification_push.php' ) {
 ...
 * @param string $url as param.
 */
function izooto_log_error( $array, $url = 'http://api.izooto.com/plugin/wp/wp_log_error.php' ) {
	$response = wp_remote_post( $url, $array );
	return $response;
}
