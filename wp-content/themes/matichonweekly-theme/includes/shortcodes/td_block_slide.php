                ...
                if (!empty($posts)) {
                    ...
                    while ($td_post_count - $ud_rendered_ad_count < sizeof( $posts )) {
                        ...
                        if ( in_array( $td_post_count, array_keys( $ad_params ) ) ) {
                            ...
                            $td_module_slide = new td_module_slide( $post ); //Unixdev MOD: $post fake parameter not use if render ads
                            $buffy .= $td_module_slide->render( $td_column_number, $td_post_count, $td_unique_id_slide, $ad_spot_id );
                    ...
                    if ( ! td_util::tdc_is_live_editor_iframe() and ! td_util::tdc_is_live_editor_ajax() ) {
                        foreach ( $ad_params as $spot_id ) {
                            $td_module_slide = new td_module_slide( $post ); //Unixdev MOD: $post fake parameter not use if render ads
                            $buffy .= $td_module_slide->render( $td_column_number, $td_post_count, $td_unique_id_slide, $spot_id );
                            $td_post_count ++;
                        }
                    }
                    //----------------
