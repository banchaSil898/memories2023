...
<hr>
<div class="td-section-separator">Custom CSS in &lt;head&gt; </div>

<!-- Custom CSS in &lt;head&gt; -->
<?php echo td_panel_generator::box_start('Custom CSS in &lt;head&gt;', false); ?>
    <div class="td-box-row">
        <div class="td-box-description td-box-full">
            <span class="td-box-title">PUT YOUR CUSTOM CSS HERE</span>
            <p>The css from this box will load on all the pages of the site. Press <strong>ctrl + space</strong> while editing to bring up a suggestion box.</p>
        </div>
    </div>
    <div class="td-box-row-margin-bottom">
...
<hr>
<div class="td-section-separator">Custom Javascript in &lt;head&gt;</div>

<!-- Custom Javascript in &lt;head&gt; -->
<?php echo td_panel_generator::box_start('Custom Javascript in &lt;head&gt;', false); ?>
<div class="td-box-row">
    <div class="td-box-description td-box-full">
        <span class="td-box-title">PUT YOUR CUSTOM JAVASCRIPT HERE</span>
...
<div class="td-box-row-margin-bottom">
    ...
    echo td_panel_generator::js_editor(array(
        'ds' => 'td_option',
        'option_id' => 'uds_head_custom_javascript',
    ));
    ?>
</div>
<?php echo td_panel_generator::box_end(); ?>
...
<hr>
<div class="td-section-separator">Custom HTML in &lt;head&gt;</div>

<!-- Custom HTML in &lt;head&gt; -->
<?php echo td_panel_generator::box_start('Custom HTML in &lt;head&gt;', false); ?>
<div class="td-box-row">
    <div class="td-box-description td-box-full">
        <span class="td-box-title">PUT YOUR CUSTOM HTML HERE</span>
        <p>Add custom html easily, using this editor. The html will be placed at the head section.</p>
    </div>
</div>
<div class="td-box-row-margin-bottom">
    <?php
    echo td_panel_generator::html_editor(array(
        'ds' => 'td_option',
        'option_id' => 'uds_head_custom_html',
    ));
    ?>
</div>
<?php echo td_panel_generator::box_end();?>

<div class="td-section-separator">Custom HTML right after &lt;body&gt;</div>

<!-- CUSTOM HTML right after &lt;body&gt; tag -->
<?php echo td_panel_generator::box_start('Custom HTML right after &lt;body&gt;', false); ?>
<div class="td-box-row">
    <div class="td-box-description td-box-full">
        <span class="td-box-title">PUT YOUR CUSTOM HTML HERE</span>
        <p>Add custom html easily, using this editor. The html will be placed right after &lt;body&gt; tag.</p>
    </div>
</div>
<div class="td-box-row-margin-bottom">
    <?php
    echo td_panel_generator::html_editor(array(
        'ds' => 'td_option',
        'option_id' => 'uds_after_body_custom_html',
    ));
    ?>
</div>
<?php echo td_panel_generator::box_end();
