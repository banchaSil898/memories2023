...
<!-- HEADER BACKGROUND -->
<?php /*Unixdev MOD*/ echo td_panel_generator::box_start('Header background', false); ?>
...
<?php echo td_panel_generator::box_start('Main Menu', false); ?>
    ...
    <div class="td-box-row">
        <div class="td-box-description">
            <span class="td-box-title">Mobile menu (By Unixdev)</span>
            <p>Select a menu for the main header section</p>
        </div>
        <div class="td-box-control-full">
            <?php
...
<?php echo td_panel_generator::box_start('Matichon Group Logo URL',false); ?>

<div class="td-box-row">
    <div class="td-box-description">
        <span class="td-box-title">Technologychaoban URL</span>
        <p>Enter the URL website</p>
    </div>
    <div class="td-box-control-full">
        <?php
        echo td_panel_generator::input(array(
            'ds' => 'td_option',
            'option_id' => 'ud_technologychaoban_logo_url'
        ));
        ?>
    </div>
</div>
...
<div class="td-box-row">
    <div class="td-box-description">
        <span class="td-box-title">Silpa-mag URL</span>
        <p>Enter the URL website</p>
    </div>
    <div class="td-box-control-full">
        <?php
        echo td_panel_generator::input(array(
            'ds' => 'td_option',
            'option_id' => 'ud_silpa_mag_logo_url'
        ));
        ?>
    </div>
</div>
...
<div class="td-box-row">
    <div class="td-box-description">
        <span class="td-box-title">Sentangsedtee URL</span>
        <p>Enter the URL website</p>
    </div>
    <div class="td-box-control-full">
        <?php
        echo td_panel_generator::input(array(
            'ds' => 'td_option',
            'option_id' => 'ud_sentangsedtee_logo_url'
        ));
        ?>
    </div>
</div>
