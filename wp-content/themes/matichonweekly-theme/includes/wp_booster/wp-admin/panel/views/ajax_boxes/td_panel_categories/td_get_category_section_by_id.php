...
<div class="td-box-row">
    <div class="td-box-description">
        <span class="td-box-title">Force Column Number (By Unixdev)</span>
    ...
    <div class="td-box-control-full">
        ...
        echo td_panel_generator::dropdown(array(
            'ds' => 'td_category',
            'item_id' => $category_id,
            'option_id' => 'udc_force_column_number',
            'values' => array(
                array (
                    'val' => '',
                    'text' => 'Inherit from global settings'
...
<div class="td-box-row">
    <div class="td-box-description">
        <span class="td-box-title">CUSTOM CSS (by Unixdev)</span>
        <p>Custom CSS for td-ss-main-content tag</p>
    </div>
    <div class="td-box-control-full td-panel-sidebar-pos">
        <div class="td-display-inline-block">
            <?php
...
<div class="td-box-row">
    <div class="td-box-description">
        <span class="td-box-title">Enable/Disable loop wrap (white box wrap) (by Unixdev)</span>
        <p>Enable/Disable loop wrap (white box wrap)</p>
    </div>
    <div class="td-box-control-full td-panel-sidebar-pos">
        <?php
        echo td_panel_generator::dropdown(array(
            'ds' => 'td_category',
            'option_id' => 'udc_loop_wrap_mode',
            'item_id' => $category_id,
            'values' => array(
                array (
                    'val' => '',
