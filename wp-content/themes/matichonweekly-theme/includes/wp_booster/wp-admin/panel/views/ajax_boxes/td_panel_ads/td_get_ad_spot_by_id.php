...
if (!isset($ad_fields['ad_field_after_paragraph']) || (isset($ad_fields['ad_field_after_paragraph']) && $ad_fields['ad_field_after_paragraph'] !== false)) {
	...
	<div class="td-box-row">
		...
		<div class="td-box-control-full">
			...
			echo td_panel_generator::input( array(
				'ds'        => 'td_option',
				'option_id' => 'tds_' . $ad_spot_id . '_ad_paragraph'
			) );
			?>
		</div>
	</div>
	...
	<div class="td-box-row">
		<div class="td-box-description">
			<span class=" td-box-title">UNIT OF AFTER PARAGRAPH OPTION</span>
			<p>Unit of after paragraph option</p>
		</div>
		<div class="td-box-control-full">
			<?php
			echo td_panel_generator::radio_button_control(array(
				'ds' => 'td_option',
				'option_id' => 'tds_' . $ad_spot_id . '_ad_paragraph_unit',
				'values' => array(
					array('text' => 'Index of paragraph', 'val' => ''),
					array('text' => 'Percentage of content', 'val' => 'percentage')
				)
			));
			?>
		</div>
	...
	<div class="td-box-row">
		...
		<div class="td-box-control-full td-panel-module">
			...
			echo td_panel_generator::visual_select_o(array(
				'ds' => 'td_option',
				'option_id' => 'tds_' . $ad_spot_id . '_ad_align',
				'values' => array(
...
//Unixdev MOD
if ( isset( $ad_fields['ud_ad_field_limit_height'] ) && $ad_fields['ud_ad_field_limit_height'] === true ) {
    // Unixdev modify to add admin panel for setting height of sticky ads
?>
    <div class="td-box-row">
        <div class="td-box-description">
            <span class="td-box-title">Ads Height on Desktop</span>
            <p>Leave blank if you want the ads to pop up with its original height</p>
        </div>
        <div class="td-box-control-full">
            <?php
            echo td_panel_generator::input(array(
    ...
    <div class="td-box-row">
        <div class="td-box-description">
            <span class="td-box-title">Ads Height on Tablet Landscape</span>
            <p>Leave blank if you want the ads to pop up with its original height</p>
        </div>
        <div class="td-box-control-full">
            <?php
    ...
    <div class="td-box-row">
        <div class="td-box-description">
            <span class="td-box-title">Ads Height on Tablet Portrait</span>
            <p>Leave blank if you want the ads to pop up with its original height</p>
        </div>
        <div class="td-box-control-full">
            <?php
    ...
    <div class="td-box-row">
        <div class="td-box-description">
            <span class="td-box-title">Ads Height on Phone </span>
            <p>Leave blank if you want the ads to pop up with its original height</p>
        </div>
        <div class="td-box-control-full">
            <?php
