...
<div class="td-meta-box-inside">
    ...
    <div class="td-page-option-panel td-page-option-post-list">
        ...
        <div class="td-meta-box-row">
            <?php $mb->the_field('ud_force_column_number'); ?>

            <?php
            $ud_force_column_number_option = array(
                'none' => '',
                '1' => '1',
                '2' => '2',
                '3' => '3',
            ...
            <span class="td-page-o-custom-label">
                ...
                <?php
                td_util::tooltip_html('
                        <h3>Force Column Number (By Unixdev):</h3>
                        <p>Force column number</p>
                    ', 'right')
                ?>
            </span>
            <div class="td-select-style-overwrite">
                <select name="<?php $mb->the_name(); ?>" class="td-panel-dropdown">
                    <?php
                    foreach ($ud_force_column_number_option as $option_name => $option_id) {
                        ?>
                        <option value="<?php echo $option_id?>"<?php $mb->the_select_state($option_id); ?>><?php echo $option_name?></option>
                        <?php
                    }
                    ?>
                </select>
            </div>
            <span class="td-page-o-info">Force column number (By Unixdev)</span>
        </div>

        <!-- custom css -->
        <div class="td-meta-box-row">
            <?php $mb->the_field('ud_custom_css'); ?>
            <span class="td-page-o-custom-label">
                Custom CSS:
                <?php
                td_util::tooltip_html('
                        <h3>Custom CSS (By Unixdev): </h3>
                        <p>you can insert custom css to td-ss-main-content tag</p>
                    ', 'right')
                ?>
            </span>
            <input type="text" name="<?php $mb->the_name(); ?>" value="<?php $mb->the_value(); ?>"/>
            <span class="td-page-o-info">Custom css for td-ss-main-content tag (By Unixdev)</span>
        </div>

        <!-- enable disable ud_loop_inner wrap -->
        <div class="td-meta-box-row">
            <span class="td-page-o-custom-label">Loop Wrap Mode:</span>
            <?php $mb->the_field('ud_loop_wrap_mode'); ?>
            <div class="td-select-style-overwrite td-inline-block-wrap">
                <select name="<?php $mb->the_name(); ?>" class="td-panel-dropdown">
                    <option value=""> - enable - </option>
                    <option value="disable"<?php $mb->the_select_state('disable'); ?>>disable</option>
                </select>
            </div>
        </div>
    ...
    <div class="td-page-option-panel td-page-option-ads">
        ...
        $ud_all_bottom_loop_ad_spot_ids = $ud_all_top_loop_ad_spot_ids;

        $ud_all_takeover_ad_spot_ids = array(
            'none' => '',
            'takeover_home_ad' => 'ud_takeover_home_ad',
            'takeover_cat_ad' => 'ud_takeover_cat_ad',
        );

        $ud_all_under_menu_ad_spot_ids = array(
            'none' => '',
        ...
        <div class="td-meta-box-row">
            ...
            <?php $mb->the_field('ud_header_ads_spot_id'); ?>
            <div class="td-select-style-overwrite td-inline-block-wrap">
                <select name="<?php $mb->the_name(); ?>" class="td-panel-dropdown">
                    <?php
                    foreach ($ud_all_header_ad_spot_ids as $ud_ad_name => $ud_ad_spot_id) {
                        ?>
        ...
        <div class="td-meta-box-row">
            ...
            <div class="td-select-style-overwrite td-inline-block-wrap">
                <select name="<?php $mb->the_name(); ?>" class="td-panel-dropdown">
                    <?php
                    foreach ($ud_all_footer_ad_spot_ids as $ud_ad_name => $ud_ad_spot_id) {
                        ?>
                        <option value="<?php echo $ud_ad_spot_id?>"<?php $mb->the_select_state($ud_ad_spot_id); ?>><?php echo $ud_ad_name?></option>
                        <?php
                    }
        ...
        <div class="td-meta-box-row">
            ...
            <?php $mb->the_field('ud_top_loop_ad_spot_id'); ?>
            <div class="td-select-style-overwrite td-inline-block-wrap">
                <select name="<?php $mb->the_name(); ?>" class="td-panel-dropdown">
                    <?php
                    foreach ($ud_all_top_loop_ad_spot_ids as $ud_ad_name => $ud_ad_spot_id) {
                        ?>
                        <option value="<?php echo $ud_ad_spot_id?>"<?php $mb->the_select_state($ud_ad_spot_id); ?>><?php echo $ud_ad_name?></option>
                        <?php
                    }
        ...
        <div class="td-meta-box-row">
            ...
            <div class="td-select-style-overwrite td-inline-block-wrap">
                <select name="<?php $mb->the_name(); ?>" class="td-panel-dropdown">
                    <?php
                    foreach ( $ud_all_takeover_ad_spot_ids as $ud_ad_name => $ud_ad_spot_id) {
                        ?>
                        <option value="<?php echo $ud_ad_spot_id?>"<?php $mb->the_select_state($ud_ad_spot_id); ?>><?php echo $ud_ad_name?></option>
                        <?php
                    }
        ...
        <div class="td-meta-box-row">
            ...
            <div class="td-select-style-overwrite td-inline-block-wrap">
                <select name="<?php $mb->the_name(); ?>" class="td-panel-dropdown">
                    <?php
                    foreach ( $ud_all_under_menu_ad_spot_ids as $ud_ad_name => $ud_ad_spot_id) {
                        ?>
                        <option value="<?php echo $ud_ad_spot_id?>"<?php $mb->the_select_state($ud_ad_spot_id); ?>><?php echo $ud_ad_name?></option>
                        <?php
                    }
    ...
    </div><!-- /page option ads tab -->
    <?php //------- end Unixdev mOD ----------- ?>


    <div class="td-page-option-panel td-page-option-loop-block-mode">

        <p>
            <strong>Note:</strong> Option apply only you use Loop Block MODE.
        </p>
        <?php
        $ud_loop_block_mode= array(
            'disable' => '',
            'columnist' => 'columnist',
        );
        ?>
        ...
        <div class="td-meta-box-row">
            ...
            <?php $mb->the_field('ud_loop_block_mode'); ?>
            <div class="td-select-style-overwrite td-inline-block-wrap">
                <select name="<?php $mb->the_name(); ?>" class="td-panel-dropdown">
                    <?php
                    foreach ($ud_loop_block_mode as $ud_loop_block_mode_name => $ud_loop_block_mode_value) {
                        ?>
                        <option value="<?php echo $ud_loop_block_mode_value?>"<?php $mb->the_select_state($ud_loop_block_mode_value); ?>><?php echo $ud_loop_block_mode_name?></option>
                        <?php
                    }
                    ?>
                </select>
    ...
    </div><!-- /page option loop block mode -->
    <?php //------- end Unixdev mOD ----------- ?>
