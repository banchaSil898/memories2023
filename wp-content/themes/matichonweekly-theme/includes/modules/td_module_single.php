...
class td_module_single extends td_module_single_base {
    ...
    function get_social_sharing_top() {
        ...
        $buffy .= '<div class="td-post-sharing td-post-sharing-top ' . $td_no_like . '">';
	        ...
	        if (td_util::get_option('tds_top_social_show') != 'hide') {
                ...
                //Unixdev MOD -------------
                $buffy .= '<div class="td-default-sharing">';
                $buffy .= '<div class="ud-sharing-summary"><i class="td-icon-share"></i></div>';
                $buffy .= '<a class="td-social-sharing-buttons td-social-facebook" href="https://www.facebook.com/sharer.php?u=' . urlencode( esc_url( get_permalink() ) ) . '" onclick="window.open(this.href, \'mywin\',\'left=50,top=50,width=600,height=350,toolbar=0\'); return false;"><i class="td-icon-facebook"></i><div class="td-social-but-text">Facebook</div></a>';
                $buffy .= '<a class="td-social-sharing-buttons td-social-twitter" href="https://twitter.com/intent/tweet?text=' . htmlspecialchars(urlencode(html_entity_decode($this->title, ENT_COMPAT, 'UTF-8')), ENT_COMPAT, 'UTF-8') . '&url=' . urlencode( esc_url( get_permalink() ) ) . '&via=' . urlencode( $twitter_user ? $twitter_user : get_bloginfo( 'name' ) ) . '"  ><i class="td-icon-twitter"></i><div class="td-social-but-text">Twitter</div></a>';
		        $buffy .= '<a class="td-social-sharing-buttons td-social-google" href="https://plus.google.com/share?url=' . esc_url( get_permalink() ) . '" onclick="window.open(this.href, \'mywin\',\'left=50,top=50,width=600,height=350,toolbar=0\'); return false;"><i class="td-icon-googleplus"></i><div class="td-social-but-text">Google+</div></a>';
                $buffy .= '<a class="td-social-sharing-buttons ud-social-sharing-line" href="https://lineit.line.me/share/ui?url=' . urlencode( esc_url( get_permalink() ) ) . '" onclick="window.open(this.href, \'mywin\',\'left=50,top=50,width=600,height=650,toolbar=0\'); return false;"><i class="ud-social-icon-line"></i><div class="td-social-but-text">LINE</div></a>';
                // $buffy .= '<a class="td-social-sharing-buttons td-social-pinterest" href="https://pinterest.com/pin/create/button/?url=' . esc_url( get_permalink() ) . '&amp;media=' . ( ! empty( $image[0] ) ? $image[0] : '' ) . '&description=' . $td_pinterest_share_description . '" onclick="window.open(this.href, \'mywin\',\'left=50,top=50,width=600,height=350,toolbar=0\'); return false;"><i class="td-icon-pinterest"></i></a>';
                // $buffy .= '<a class="td-social-sharing-buttons td-social-whatsapp" href="whatsapp://send?text=' . htmlspecialchars(urlencode(html_entity_decode($this->title, ENT_COMPAT, 'UTF-8')), ENT_COMPAT, 'UTF-8') . '%20-%20' . urlencode( esc_url( get_permalink() ) ) . '" ><i class="td-icon-whatsapp"></i></a>';
                $buffy .= '</div>';
                //------------------------------
	        }
    ...
    function get_social_sharing_bottom() {
        ...
        // @todo single-post-thumbnail appears to not be in used! please check
        $image = wp_get_attachment_image_src( get_post_thumbnail_id( $this->post->ID ), 'single-post-thumbnail' );
        $buffy .= '<div class="td-post-sharing td-post-sharing-bottom ' . $td_no_like . '">'; //Unixdev MOD
